...
\hypertarget{arm__vec__math_8h_source}{}\label{arm__vec__math_8h_source}\index{Middlewares/Third\_Party/ARM\_CMSIS/Include/arm\_vec\_math.h@{Middlewares/Third\_Party/ARM\_CMSIS/Include/arm\_vec\_math.h}}
...
\DoxyCodeLine{00025\ }
\DoxyCodeLine{00026\ \textcolor{preprocessor}{\#ifndef\ ARM\_VEC\_MATH\_H}}
\DoxyCodeLine{00027\ \textcolor{preprocessor}{\#define\ ARM\_VEC\_MATH\_H}}
\DoxyCodeLine{00028\ }
...
\DoxyCodeLine{00041\ }
\DoxyCodeLine{00042\ \textcolor{keyword}{static}\ \textcolor{keyword}{const}\ \doxymbox{\hyperlink{group__generic_types_ga4611b605e45ab401f02cab15c5e38715}{float32\_t}}\ \_\_logf\_rng\_f32=0.693147180f;}
\DoxyCodeLine{00043\ }
\DoxyCodeLine{00044\ }
...
\DoxyCodeLine{00068\ }
\DoxyCodeLine{00069\ \ \ \ \ xinv.f\ =\ vdupq\_m(xinv.f,\ F32\_MAX,\ vcmpeqq(x,\ 0.0f));}
...
\DoxyCodeLine{00105\ }
\DoxyCodeLine{00106\ \ \ \ \ xinv.f\ =\ vdupq\_m(xinv.f,\ F32\_MAX,\ vcmpeqq(x,\ 0.0f));}
...
\DoxyCodeLine{00130\ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ \doxymbox{\hyperlink{group__generic_types_ga4611b605e45ab401f02cab15c5e38715}{float32\_t}}\ *\ coeffs)}
\DoxyCodeLine{00131\ \{}
...
\DoxyCodeLine{00216\ \ \ \ \ vecAcc0\ =\ vdupq\_m(vecAcc0,\ -\/F32\_MAX,\ vcmpeqq(vecIn,\ 0.0f));}
...
\DoxyCodeLine{00269\ }
\DoxyCodeLine{00270\ \ \ \ \ v.f\ =\ vdupq\_m(v.f,\ F32\_MAX,\ vcmpeqq(vecIn,\ 0.0f));}
